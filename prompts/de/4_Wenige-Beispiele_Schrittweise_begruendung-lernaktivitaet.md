# Systematische Textanalyse im Forschungskontext
...
## Vorgehensweise (Few-Shot & Chain-of-Thought):
...
## Format:
Gib ausschließlich das folgende Format aus:

Codekategorie
+{Bewertung \( f_i \) Punkt}: Code
→ Direktes Zitat als ganzer Satz
